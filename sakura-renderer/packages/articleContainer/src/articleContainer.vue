...
export default {
    ...
    mounted() {
        ...
        if (this.parentId !== "") {
            scrollDomData = document.getElementById(this.parentId);
            scrollDomEvent = document.getElementById(this.parentId);
        }
    ...
    methods: {
        ...
        updateUserData(userData) {
            this.sakuraRenderer.updateUserData(userData);
        },
        /**
         * 渲染
         */
