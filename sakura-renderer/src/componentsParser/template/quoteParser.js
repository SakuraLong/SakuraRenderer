...
class QuoteParser extends Template {
    ...
    analyseTemplate(content) {
        ...
        td_s_l.classList.add("class", "sa-quote-table_td-symbol");
        td_s_r.classList.add("class", "sa-quote-table_td-symbol");
        td_c.classList.add("class", "sa-quote-table_td-text");
        td_f.classList.add("class", "sa-quote-table_td-from");
